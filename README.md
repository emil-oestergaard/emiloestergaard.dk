...
**TL;DR:** Ubuntu 24.04 on the cheapest Hetzner tier (CX23 at the time
of writing) → hardened SSH and UFW → Caddy (or nginx + certbot) →
Let's Encrypt TLS → rsync deploys. Nothing fancier.
